...
const matchImageSnapshot = (defaultOptionsOverrides) => (subject, nameOrCommandOptions, commandOptions) => {
    ...
    const isFailOnSnapshotDiff = typeof Cypress.env('failOnSnapshotDiff') === 'undefined' || false;
...
const getNameAndOptions = (nameOrCommandOptions, defaultOptionsOverrides, commandOptions) => {
    let filename;
    let options = (0, just_extend_1.default)(true, {}, defaultOptions, defaultOptionsOverrides);
    if (typeof nameOrCommandOptions === 'string' && commandOptions) {
        filename = nameOrCommandOptions;
        options = (0, just_extend_1.default)(true, {}, defaultOptions, defaultOptionsOverrides, commandOptions);
    }
    if (typeof nameOrCommandOptions === 'string') {
        filename = nameOrCommandOptions;
    }
    if (typeof nameOrCommandOptions === 'object') {
        options = (0, just_extend_1.default)(true, {}, defaultOptions, defaultOptionsOverrides, nameOrCommandOptions);
    }
